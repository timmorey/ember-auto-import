...
class LeaderChooser {
    ...
    register(addon, create) {
        ...
        if (shared_internals_1.isDeepAddonInstance(addon)) {
            ...
            let range = '^2.2.2' // (_a = dependencies === null || dependencies === void 0 ? void 0 : dependencies['ember-auto-import']) !== null && _a !== void 0 ? _a : devDependencies === null || devDependencies === void 0 ? void 0 : devDependencies['ember-auto-import'];
