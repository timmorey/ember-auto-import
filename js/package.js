...
class Package {
    ...
    requestedRange(packageName) {
        var _a, _b, _c;
        let { pkg } = this;
        return ((_a = pkg.dependencies) === null || _a === void 0 ? void 0 : _a[packageName]) || ((_b = pkg.devDependencies) === null || _b === void 0 ? void 0 : _b[packageName]) || ((_c = pkg.peerDependencies) === null || _c === void 0 ? void 0 : _c[packageName]);
    }
    hasNonDevDependency(name) {
        var _a, _b, _c;
        let pkg = this.pkg;
        return Boolean(((_a = pkg.dependencies) === null || _a === void 0 ? void 0 : _a[name]) || ((_b = pkg.peerDependencies) === null || _b === void 0 ? void 0 : _b[name]) || ((_c = this.magicDeps) === null || _c === void 0 ? void 0 : _c.has(name)));
    }
    ...
    get styleLoaderOptions() {
        ...
        return this.isAddon ? undefined : (_a = this.autoImportOptions) === null || _a === void 0 ? void 0 : _a.styleLoaderOptions;
    }
...
function isV1EmberAddonDependency(packageRoot) {
    ...
    if (cached === undefined) {
        ...
        let answer = ((_a = packageJSON.keywords) === null || _a === void 0 ? void 0 : _a.includes('ember-addon')) && ((_c = (_b = packageJSON['ember-addon']) === null || _b === void 0 ? void 0 : _b.version) !== null && _c !== void 0 ? _c : 1) < 2;
